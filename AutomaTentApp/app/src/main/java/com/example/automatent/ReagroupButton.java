...
public class ReagroupButton extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reagroup_button);
        ...
        findViewById(R.id.backButton).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ReagroupButton.this, Devices.class);
